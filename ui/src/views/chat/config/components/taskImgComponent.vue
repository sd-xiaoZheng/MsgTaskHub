<template>
    <el-dialog title="素材管理" :visible.sync="dialogValue">
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple"
                    @click="handleDelete" v-hasPermi="['system:taskImg:remove']">删除</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="taskImgList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="图片地址" align="center" prop="path">
                <template #default="scope">
                    <el-image style="width: 80px; height: 80px" :src="imgUrl + scope.row.path"
                        :preview-src-list="[imgUrl + scope.row.path]">
                    </el-image>
                </template>
            </el-table-column>
