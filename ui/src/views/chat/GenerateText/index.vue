<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['chat:GenerateText:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['chat:GenerateText:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['chat:GenerateText:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['chat:GenerateText:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="GenerateTextList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="绑定的中间表id" align="center" prop="tlmId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="绑定的中间表id" prop="tlmId">
          <el-input v-model="form.tlmId" placeholder="请输入绑定的中间表id" />
        </el-form-item>
